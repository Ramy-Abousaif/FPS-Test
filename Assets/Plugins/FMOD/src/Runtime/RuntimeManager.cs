...
namespace FMODUnity
{
    ...
    public class RuntimeManager : MonoBehaviour
    {
        ...
        public static void PlayOneShot(string path, float volume, float pitch, string id, float param, Vector3 position = new Vector3())
        {
            try
            {
                PlayOneShot(PathToGUID(path), volume, pitch, id, param, position);
            }
            catch (EventNotFoundException)
            {
        ...
        public static void PlayOneShot(Guid guid, float volume, float pitch, string id, float param, Vector3 position = new Vector3())
        {
            var instance = CreateInstance(guid);
            instance.set3DAttributes(RuntimeUtils.To3DAttributes(position));
            instance.setVolume(volume);
            instance.setPitch(pitch);
            instance.setParameterByName(id, param);
            instance.start();
            instance.release();
        }

        public static void PlayOneShot(string path, float volume, float pitch, Vector3 position = new Vector3())
        {
            try
            {
                PlayOneShot(PathToGUID(path), volume, pitch, position);
            }
            catch (EventNotFoundException)
            {
                Debug.LogWarning("[FMOD] Event not found: " + path);
        ...
        public static void PlayOneShot(Guid guid, float volume, float pitch, Vector3 position = new Vector3())
        {
            var instance = CreateInstance(guid);
            instance.set3DAttributes(RuntimeUtils.To3DAttributes(position));
            instance.setVolume(volume);
        ...
        public static void PlayOneShotAttached(string path, GameObject gameObject, float volume, float pitch)
        {
            try
            {
                PlayOneShotAttached(PathToGUID(path), gameObject, volume, pitch);
            }
            catch (EventNotFoundException)
            {
                Debug.LogWarning("[FMOD] Event not found: " + path);
        ...
        public static void PlayOneShotAttached(Guid guid, GameObject gameObject, float volume, float pitch)
        {
            var instance = CreateInstance(guid);
            instance.setVolume(volume);
            instance.setPitch(pitch);
        ...
        public static void PlayOneShotAttached(string path, string id, float param, GameObject gameObject, float volume, float pitch)
        {
            try
            {
                PlayOneShotAttached(PathToGUID(path), id, param, gameObject, volume, pitch);
            }
            catch (EventNotFoundException)
            {
                Debug.LogWarning("[FMOD] Event not found: " + path);
        ...
        public static void PlayOneShotAttached(Guid guid, string id, float param, GameObject gameObject, float volume, float pitch)
        {
            var instance = CreateInstance(guid);
            instance.setVolume(volume);
            instance.setPitch(pitch);
        ...
        public static void PlayOneShotAttached(string path, string id, float param, GameObject gameObject, float volume)
        {
            try
            {
                PlayOneShotAttached(PathToGUID(path), id, param, gameObject, volume);
            }
            catch (EventNotFoundException)
            {
                Debug.LogWarning("[FMOD] Event not found: " + path);
        ...
        public static void PlayOneShotAttached(Guid guid, string id, float param, GameObject gameObject, float volume)
        {
            var instance = CreateInstance(guid);
            instance.setVolume(volume);
            instance.setParameterByName(id, param);
